...
public class OriginalSpawnEggs extends ItemMonsterPlacer {

	public final int primaryColor;
	public final int secondaryColor;

	// このスポーンエッグから生成されるエンティティのリスト
	public static Class[] spawnableEntities = { EntityCombineMob.class, };

	public OriginalSpawnEggs(int par1, int par2) {
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4,
		...
		if (par3World.isRemote) {
			...
			Entity entity = spawnCreature(par3World, par1ItemStack.getItemDamage(), par4 + 0.5D, par5 + d0,
					par6 + 0.5D);
